...
const TeamCard: React.FC<TeamCardProps> = ({ name, role, bio, image, linkedin, github }) => {
  return (
    <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 text-center group">
      ...
      <div className="flex justify-center space-x-4">
        {linkedin && (
          <a href={linkedin} className="text-blue-600 hover:text-blue-800 transition-colors">
        ...
        {github && (
          <a href={github} className="text-gray-700 hover:text-gray-900 transition-colors">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
